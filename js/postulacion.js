...
async function cargarCargos() {
  ...
  try {
    ...
    activas.forEach((vacante) => {
      const opcion = new Option(`${vacante.nombre_cargo || vacante.titulo} — ${vacante.nombre_sede || 'Sede no definida'}`, String(vacante.id_vacante));
      opcion.dataset.cargo = vacante.nombre_cargo || vacante.titulo;
